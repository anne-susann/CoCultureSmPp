...
feature_info_ENDO_pos <- data.frame(cbind(ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@rownames, 
                                          ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@listData[["mzmed"]], 
                                          ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@listData[["mzmin"]], 
                                          ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@listData[["mzmax"]], 
                                          ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@listData[["rtmed"]], 
                                          ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@listData[["rtmin"]], 
                                          ms1_data_ENDO_pos@msFeatureData[["featureDefinitions"]]@listData[["rtmax"]]))
# add column names
