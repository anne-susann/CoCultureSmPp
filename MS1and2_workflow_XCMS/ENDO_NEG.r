...
plot(ms_pca_ENDO_neg$x[, 1], ms_pca_ENDO_neg$x[,2], pch=19, main="PCA: Grouping of samples",
     ...
     col=color, cex=0.8)
grid()
text(ms_pca_ENDO_neg$x[, 1], ms_pca_ENDO_neg$x[,2], labels=ms_data_ENDO_neg$sample_name, col=color, pos=3, cex=0.9)
...
bina_list_ENDO_neg[bina_list_ENDO_neg < log2(ms_intensity_cutoff)] <- 0
